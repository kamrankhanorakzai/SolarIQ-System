...
path = os.path.join(BASE_DIR, "data", "train_test_data", "train_test_kwh")

train_model_path = os.path.join(BASE_DIR, "models","train_model","kwh_model","train_model_kwh.pkl")
...
# MAIN WITH MLFLOW
# -------------------------------
with mlflow.start_run(run_name="train_test_kwh_model"):
    ...
    if model is not None:
        ...
        mlflow.sklearn.log_model(model, "train_test_kwh_model")
